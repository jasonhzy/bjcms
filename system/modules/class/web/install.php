...
EOF;
					...
					header("Location:".web_url("install",array("name"=>"modules","op"=>"setp3","doact"=>"installsql", "adminname"=>urlencode(base64_encode($_GP['adminname'])), "adminpwd"=>urlencode(base64_encode(md5($_GP['adminpwd']))))));
          ...
          refreshSetting($cfg);
			 		...
			 		unset($_SESSION["account"]);
			 		http_get("http://bbs.baijiacms.com/baijiaupdate/install_log.php?hostname=".urlencode($_SERVER["HTTP_HOST"]));
