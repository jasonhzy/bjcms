...
class Common_util_pub
{
	...
	{	global $_CMS;
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".$_CMS['weixin_pay_paySignKey'];
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{	global $_CMS;
	   	$this->parameters["appid"] = $_CMS['weixin_pay_appid'];//公众账号ID
	   	$this->parameters["mch_id"] = $_CMS['weixin_pay_mchId'];//商户号
	...
	//	exit(" <textarea style='width:1000px;height:100px'> ".$this->response." </textarea> ");
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	{	global $_CMS;
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	$this->returnParameters["appid"] = $_CMS['weixin_pay_appid'];//公众账号ID
		   	$this->returnParameters["mch_id"] = $_CMS['weixin_pay_mchId'];//商户号
...
class JsApi_pub extends Common_util_pub
{
	...
	{	global $_CMS;
		$urlObj["appid"] = $_CMS['weixin_pay_appid'];
	...
	{	global $_CMS;
		$urlObj["appid"] = $_CMS['weixin_pay_appid'];
		$urlObj["secret"] = $_CMS['weixin_pay_appSecret'];
	...
	{	global $_CMS;
		$jsApiObj["appId"] = $_CMS['weixin_pay_appid'];
		$timeStamp = time();
