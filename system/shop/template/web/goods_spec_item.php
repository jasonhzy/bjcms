...
<div id="thumb0_span" tabindex="-1" class="fileupload-preview thumbnail" style="float:left;;width: 50px; height: 50px;">
     ...
     <img  width="50" height="50" onerror="nofind()"  src="<?php  if(empty($specitem['thumb'])){?><?php echo WEBSITE_ROOT;?>/assets/addons/shop/images/module-nopic-small.jpg<?php  }else{?><?php echo WEBSITE_ROOT;?>/attachment/<?php  echo $specitem['thumb']?><?php  }?>"/></div>
